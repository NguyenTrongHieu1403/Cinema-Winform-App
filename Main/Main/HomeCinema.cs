...
namespace Main
{
    public partial class HomeCinema : Form
    {
        //Fields
        ...
        public HomeCinema(string username, int cinemaID)
        {
            InitializeComponent();
        ...
        private void HomeCinema_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new StaffForm(username));
        }

        private void iconButton2_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color2);
            OpenChildForm(new MovieManager());
        }

        private void iconButton3_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color3);
            OpenChildForm(new qlSanPham(username));
        }

        private void iconButton4_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color4);
            OpenChildForm(new ShowtimeManager(CinemaID));
        }

        private void iconButton5_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color5);
            OpenChildForm(new CustomerManager());
        }
        ...
        private void iconButton6_Click_1(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new FThongKeXuHuong());
        }
        ...
        private void iconButton7_Click_2(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color7);
            OpenChildForm(new AppAbout());
        }
    }
}
